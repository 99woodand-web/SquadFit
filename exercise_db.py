...
STRENGTH_EXERCISES = {
    ...
    "b09": {"name": "Snatch-Grip Deadlift", "muscle": "Back", "equip": "Barbell",
            "equip_tags": ["barbell"], "sets": 3, "reps": 6, "compound": True,
            "tip": "Wide snatch grip, drive hips, keep back flat", "track": "strength",
            "difficulty": "Advanced", "alternatives": ["b08", "b10", "b11"]},
    "b10": {"name": "Dumbbell Deadlift", "muscle": "Back", "equip": "Dumbbells",
            "equip_tags": ["dumbbells"], "sets": 3, "reps": 10, "compound": True,
            "tip": "Hinge at hips, dumbbells by your sides", "track": "strength",
    ...
    # ========================================================================
    # KETTLEBELL EXERCISES (12)
    # ========================================================================
    "kb01": {"name": "Kettlebell Swing", "muscle": "Legs", "equip": "Kettlebell",
             "equip_tags": ["kettlebell"], "sets": 4, "reps": 15, "compound": True,
             "tip": "Hinge at hips, snap hips to drive the bell up", "track": "strength",
             "difficulty": "Intermediate", "alternatives": ["l01", "l10", "l13"]},
    "kb02": {"name": "Kettlebell Front Squat", "muscle": "Legs", "equip": "Kettlebell",
             "equip_tags": ["kettlebell"], "sets": 3, "reps": 10, "compound": True,
             "tip": "Rack position, elbows high, squat deep", "track": "strength",
             "difficulty": "Intermediate", "alternatives": ["l01", "l02", "l04"]},
    "kb03": {"name": "Kettlebell Romanian Deadlift", "muscle": "Legs", "equip": "Kettlebell",
             "equip_tags": ["kettlebell"], "sets": 3, "reps": 10, "compound": True,
             "tip": "Hinge hips, keep bell close to body", "track": "strength",
             "difficulty": "Intermediate", "alternatives": ["l10", "l11", "b09"]},
    "kb04": {"name": "Kettlebell Clean", "muscle": "Shoulders", "equip": "Kettlebell",
             "equip_tags": ["kettlebell"], "sets": 3, "reps": 8, "compound": True,
             "tip": "Explosive hip drive, rack the bell at shoulder", "track": "strength",
             "difficulty": "Advanced", "alternatives": ["s01", "s07", "s02"]},
    "kb05": {"name": "Kettlebell Snatch", "muscle": "Shoulders", "equip": "Kettlebell",
             "equip_tags": ["kettlebell"], "sets": 3, "reps": 8, "compound": True,
             "tip": "One fluid motion, punch up at the top", "track": "strength",
             "difficulty": "Advanced", "alternatives": ["kb04", "s01", "s07"]},
    "kb06": {"name": "Kettlebell Overhead Press", "muscle": "Shoulders", "equip": "Kettlebell",
             "equip_tags": ["kettlebell"], "sets": 3, "reps": 10, "compound": True,
             "tip": "Press from rack position, brace core", "track": "strength",
             "difficulty": "Intermediate", "alternatives": ["s01", "s02", "s07"]},
    "kb07": {"name": "Kettlebell Row", "muscle": "Back", "equip": "Kettlebell",
             "equip_tags": ["kettlebell"], "sets": 3, "reps": 10, "compound": True,
             "tip": "Hinge forward, pull bell to your hip", "track": "strength",
             "difficulty": "Beginner", "alternatives": ["b01", "b02", "b15"]},
    "kb08": {"name": "Kettlebell Gorilla Row", "muscle": "Back", "equip": "Kettlebell",
             "equip_tags": ["kettlebell"], "sets": 3, "reps": 12, "compound": True,
             "tip": "Two bells, row them alternately", "track": "strength",
             "difficulty": "Intermediate", "alternatives": ["b02", "b01", "b13"]},
    "kb09": {"name": "Kettlebell Floor Press", "muscle": "Chest", "equip": "Kettlebell",
             "equip_tags": ["kettlebell"], "sets": 3, "reps": 10, "compound": True,
             "tip": "Lying on floor, press from the ground up", "track": "strength",
             "difficulty": "Beginner", "alternatives": ["c03", "c01", "c09"]},
    "kb10": {"name": "Kettlebell Halo", "muscle": "Shoulders", "equip": "Kettlebell",
             "equip_tags": ["kettlebell"], "sets": 3, "reps": 10, "compound": False,
             "tip": "Circle bell around your head, core tight", "track": "strength",
             "difficulty": "Beginner", "alternatives": ["s04", "s05", "s12"]},
    "kb11": {"name": "Kettlebell Windmill", "muscle": "Core", "equip": "Kettlebell",
             "equip_tags": ["kettlebell"], "sets": 3, "reps": 8, "compound": False,
             "tip": "Hinge to the side, arm stays vertical", "track": "strength",
             "difficulty": "Advanced", "alternatives": ["co07", "co10", "co02"]},
    "kb12": {"name": "Kettlebell Farmer's Carry", "muscle": "Core", "equip": "Kettlebell",
             "equip_tags": ["kettlebell"], "sets": 3, "reps": 40, "compound": False,
             "tip": "Stand tall and walk with heavy bells", "track": "strength",
             "difficulty": "Beginner", "alternatives": ["co01", "co09", "l17"]},

    # ========================================================================
    # RESISTANCE BAND EXERCISES (12)
    # ========================================================================
    "bd01": {"name": "Band Pull-Apart", "muscle": "Shoulders", "equip": "Bands",
             "equip_tags": ["bands"], "sets": 3, "reps": 15, "compound": False,
             "tip": "Pull band apart at chest height", "track": "strength",
             "difficulty": "Beginner", "alternatives": ["s05", "s06", "b12"]},
    "bd02": {"name": "Banded Row", "muscle": "Back", "equip": "Bands",
             "equip_tags": ["bands"], "sets": 3, "reps": 12, "compound": True,
             "tip": "Anchor band, pull toward your ribs", "track": "strength",
             "difficulty": "Beginner", "alternatives": ["b03", "b01", "b15"]},
    "bd03": {"name": "Banded Lat Pulldown", "muscle": "Back", "equip": "Bands",
             "equip_tags": ["bands"], "sets": 3, "reps": 12, "compound": True,
             "tip": "Anchor overhead, pull down to chest", "track": "strength",
             "difficulty": "Beginner", "alternatives": ["b04", "b07", "b05"]},
    "bd04": {"name": "Banded Push-Up", "muscle": "Chest", "equip": "Bands",
             "equip_tags": ["bands"], "sets": 3, "reps": 12, "compound": True,
             "tip": "Band across your back adds resistance", "track": "strength",
             "difficulty": "Intermediate", "alternatives": ["c07", "c08", "c01"]},
    "bd05": {"name": "Banded Chest Press", "muscle": "Chest", "equip": "Bands",
             "equip_tags": ["bands"], "sets": 3, "reps": 12, "compound": True,
             "tip": "Anchor behind you, press forward", "track": "strength",
             "difficulty": "Beginner", "alternatives": ["c03", "c01", "c15"]},
    "bd06": {"name": "Banded Squat", "muscle": "Legs", "equip": "Bands",
             "equip_tags": ["bands"], "sets": 3, "reps": 12, "compound": True,
             "tip": "Band adds resistance at the top", "track": "strength",
             "difficulty": "Beginner", "alternatives": ["l01", "l02", "l03"]},
    "bd07": {"name": "Banded Good Morning", "muscle": "Legs", "equip": "Bands",
             "equip_tags": ["bands"], "sets": 3, "reps": 12, "compound": True,
             "tip": "Hinge hips against the band tension", "track": "strength",
             "difficulty": "Beginner", "alternatives": ["l10", "l11", "l13"]},
    "bd08": {"name": "Banded Lateral Raise", "muscle": "Shoulders", "equip": "Bands",
             "equip_tags": ["bands"], "sets": 3, "reps": 15, "compound": False,
             "tip": "Stand on band, raise arms to shoulder height", "track": "strength",
             "difficulty": "Beginner", "alternatives": ["s04", "s03", "s12"]},
    "bd09": {"name": "Banded Shoulder Press", "muscle": "Shoulders", "equip": "Bands",
             "equip_tags": ["bands"], "sets": 3, "reps": 12, "compound": True,
             "tip": "Stand on band, press overhead", "track": "strength",
             "difficulty": "Beginner", "alternatives": ["s01", "s02", "s10"]},
    "bd10": {"name": "Banded Bicep Curl", "muscle": "Biceps", "equip": "Bands",
             "equip_tags": ["bands"], "sets": 3, "reps": 15, "compound": False,
             "tip": "Stand on band, curl with control", "track": "strength",
             "difficulty": "Beginner", "alternatives": ["bi01", "bi02", "bi04"]},
    "bd11": {"name": "Banded Tricep Pushdown", "muscle": "Triceps", "equip": "Bands",
             "equip_tags": ["bands"], "sets": 3, "reps": 15, "compound": False,
             "tip": "Anchor overhead, extend your elbows", "track": "strength",
             "difficulty": "Beginner", "alternatives": ["tr01", "tr02", "tr03"]},
    "bd12": {"name": "Banded Pallof Press", "muscle": "Core", "equip": "Bands",
             "equip_tags": ["bands"], "sets": 3, "reps": 12, "compound": False,
             "tip": "Press band out, resist the rotation", "track": "strength",
             "difficulty": "Beginner", "alternatives": ["co10", "co01", "co08"]},

    # ========================================================================
    # BODYWEIGHT / CALISTHENICS EXERCISES (16)
    # ========================================================================
    "bw01": {"name": "Decline Push-Up", "muscle": "Chest", "equip": "Bodyweight",
             "equip_tags": [], "sets": 3, "reps": 12, "compound": True,
             "tip": "Feet elevated, targets the upper chest", "track": "strength",
             "difficulty": "Intermediate", "alternatives": ["c07", "c08", "c02"]},
    "bw02": {"name": "Archer Push-Up", "muscle": "Chest", "equip": "Bodyweight",
             "equip_tags": [], "sets": 3, "reps": 8, "compound": True,
             "tip": "Shift weight onto one arm, other arm straight", "track": "strength",
             "difficulty": "Advanced", "alternatives": ["c07", "c12", "bw01"]},
    "bw03": {"name": "Pike Push-Up", "muscle": "Shoulders", "equip": "Bodyweight",
             "equip_tags": [], "sets": 3, "reps": 10, "compound": True,
             "tip": "Hips high, lower head between your hands", "track": "strength",
             "difficulty": "Intermediate", "alternatives": ["s11", "s02", "s10"]},
    "bw04": {"name": "Shoulder Tap", "muscle": "Core", "equip": "Bodyweight",
             "equip_tags": [], "sets": 3, "reps": 20, "compound": False,
             "tip": "Plank position, tap opposite shoulder", "track": "strength",
             "difficulty": "Intermediate", "alternatives": ["co01", "co08", "co09"]},
    "bw05": {"name": "Pistol Squat", "muscle": "Legs", "equip": "Bodyweight",
             "equip_tags": [], "sets": 3, "reps": 6, "compound": True,
             "tip": "One-leg squat, control the descent", "track": "strength",
             "difficulty": "Advanced", "alternatives": ["l05", "l01", "l04"]},
    "bw06": {"name": "Jump Squat", "muscle": "Legs", "equip": "Bodyweight",
             "equip_tags": [], "sets": 3, "reps": 15, "compound": True,
             "tip": "Explode up, land soft on your toes", "track": "strength",
             "difficulty": "Intermediate", "alternatives": ["l01", "l02", "cr14"]},
    "bw07": {"name": "Single-Leg Glute Bridge", "muscle": "Legs", "equip": "Bodyweight",
             "equip_tags": [], "sets": 3, "reps": 12, "compound": False,
             "tip": "Drive through the heel, squeeze the glute", "track": "strength",
             "difficulty": "Beginner", "alternatives": ["l14", "l13", "l16"]},
    "bw08": {"name": "Step-Up", "muscle": "Legs", "equip": "Bodyweight",
             "equip_tags": [], "sets": 3, "reps": 12, "compound": True,
             "tip": "Drive through the top foot, chest up", "track": "strength",
             "difficulty": "Beginner", "alternatives": ["l06", "l07", "l05"]},
    "bw09": {"name": "Wall Sit", "muscle": "Legs", "equip": "Bodyweight",
             "equip_tags": [], "sets": 3, "reps": 45, "compound": False,
             "tip": "Thighs parallel, back flat against the wall", "track": "strength",
             "difficulty": "Beginner", "alternatives": ["l01", "l03", "l08"]},
    "bw10": {"name": "Reverse Nordic Curl", "muscle": "Legs", "equip": "Bodyweight",
             "equip_tags": [], "sets": 3, "reps": 8, "compound": False,
             "tip": "Kneel, lean back slowly under control", "track": "strength",
             "difficulty": "Advanced", "alternatives": ["l08", "l12", "l09"]},
    "bw11": {"name": "Superman Hold", "muscle": "Back", "equip": "Bodyweight",
             "equip_tags": [], "sets": 3, "reps": 30, "compound": False,
             "tip": "Lift arms and legs, squeeze the lower back", "track": "strength",
             "difficulty": "Beginner", "alternatives": ["b12", "b11", "co01"]},
    "bw12": {"name": "Inverted Row", "muscle": "Back", "equip": "Bodyweight",
             "equip_tags": [], "sets": 3, "reps": 10, "compound": True,
             "tip": "Body under a bar, pull chest to the bar", "track": "strength",
             "difficulty": "Intermediate", "alternatives": ["b01", "b03", "b05"]},
    "bw13": {"name": "Scapular Pull-Up", "muscle": "Back", "equip": "Bodyweight",
             "equip_tags": [], "sets": 3, "reps": 10, "compound": False,
             "tip": "Dead hang, retract your shoulder blades", "track": "strength",
             "difficulty": "Beginner", "alternatives": ["b05", "b06", "b07"]},
    "bw14": {"name": "Bench Dip", "muscle": "Triceps", "equip": "Bodyweight",
             "equip_tags": [], "sets": 3, "reps": 12, "compound": True,
             "tip": "Hands on a bench, lower your body", "track": "strength",
             "difficulty": "Beginner", "alternatives": ["tr07", "tr01", "tr05"]},
    "bw15": {"name": "Dragon Flag", "muscle": "Core", "equip": "Bodyweight",
             "equip_tags": [], "sets": 3, "reps": 6, "compound": False,
             "tip": "Lie on a bench, lift a straight body line", "track": "strength",
             "difficulty": "Advanced", "alternatives": ["co04", "co12", "co05"]},
    "bw16": {"name": "Hollow Body Hold", "muscle": "Core", "equip": "Bodyweight",
             "equip_tags": [], "sets": 3, "reps": 30, "compound": False,
             "tip": "Lower back pressed down, arms overhead", "track": "strength",
             "difficulty": "Intermediate", "alternatives": ["co01", "co06", "co08"]},
}
