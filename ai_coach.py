...
COMPOUND_MUSCLE_MAP = {
    ...
    "Kettlebell Swing": ["Legs", "Core"],
    "Kettlebell Front Squat": ["Legs", "Core"],
    "Kettlebell Romanian Deadlift": ["Legs", "Back"],
    "Kettlebell Clean": ["Shoulders", "Legs"],
    "Kettlebell Snatch": ["Shoulders", "Legs"],
    "Kettlebell Overhead Press": ["Shoulders", "Triceps"],
    "Kettlebell Row": ["Back", "Biceps"],
    "Kettlebell Gorilla Row": ["Back", "Biceps"],
    "Kettlebell Floor Press": ["Chest", "Triceps"],
    "Banded Row": ["Back", "Biceps"],
    "Banded Lat Pulldown": ["Back", "Biceps"],
    "Banded Push-Up": ["Chest", "Triceps"],
    "Banded Chest Press": ["Chest", "Triceps"],
    "Banded Squat": ["Legs", "Core"],
    "Banded Good Morning": ["Legs", "Back"],
    "Banded Shoulder Press": ["Shoulders", "Triceps"],
    "Decline Push-Up": ["Chest", "Triceps"],
    "Archer Push-Up": ["Chest", "Triceps"],
    "Pike Push-Up": ["Shoulders", "Triceps"],
    "Pistol Squat": ["Legs", "Core"],
    "Jump Squat": ["Legs", "Core"],
    "Step-Up": ["Legs", "Core"],
